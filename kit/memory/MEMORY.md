...
- [Role & expertise](examples/user_role.md) - backend-heavy, new to this repo's frontend; frame frontend in backend terms
...
- [Issue tracker](examples/reference_issue_tracker.md) - pipeline bugs live in the "INGEST" tracker; check it for ticket context
